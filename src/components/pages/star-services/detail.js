                        ...
                        <div className="row align-items-center">
                            <div className="border-0 mb-4">
                                <div className="card-header py-3 no-bg bg-transparent d-flex align-items-center px-0 justify-content-between border-bottom flex-wrap">
                                    <h3 className="fw-bold mb-0">Service Detail</h3>
                                </div>
                            </div>
                        </div>
                                            ...
                                            <div className="card-body">
                                                <div className="d-flex align-items-center">
                                                    ...
                                                    <div className="flex-fill ms-4 text-truncate">
                                                        ...
                                                        <span className="fw-bold">{servicesDetail.serviceName}</span>
                                                    </div>
                                ...
                                <div className="row g-3">
                                    <div className="col-md-12">
                                        <div className="card mb-3">
                                            <div className="card-body">
                                                <h6 className="fw-bold mb-3 text-danger">Service Description</h6>
                                                <p>{servicesDetail.serviceDescription}</p>
                                            </div>
                                        </div>
                                        <div className="row g-3">
