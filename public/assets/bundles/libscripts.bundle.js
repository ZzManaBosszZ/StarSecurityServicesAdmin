(function (e, t) {
    ...
    try {
        k.apply((t = a.call(r.childNodes)), r.childNodes), t[r.childNodes.length].nodeType;
    } catch (e) {
        k = {
            apply: function (e, t) {
                le.apply(e, a.call(t));
    ...
    function D(t, e, n, i) {
        ...
        if (!i && (Pe(e), (e = e || C), A)) {
            ...
            if (!(he[t + " "] || (f && f.test(t)))) {
                if (((c = t), (u = e), 1 === d && (be.test(t) || ye.test(t)))) {
                    for (((u = (Ae.test(t) && Ne(e.parentNode)) || e) == e && g.scope) || ((s = e.getAttribute("id")) ? (s = T.escapeSelector(s)) : e.setAttribute("id", (s = S))), o = (l = Me(t)).length; o--; )
                        l[o] = (s ? "#" + s : ":scope") + " " + He(l[o]);
                    c = l.join(",");
                }
                try {
        ...
        return ze(t.replace(ee, "$1"), e, n, i);
    }
    function Oe() {
        var n = [];
        function i(e, t) {
    ...
    function Pe(e) {
        ...
        return (
            e != C &&
                ...
                (A = !T.isXMLDoc(C)),
                (ae = i.matches || i.webkitMatchesSelector || i.msMatchesSelector),
                i.msMatchesSelector && r != C && (e = C.defaultView) && e.top !== e && e.addEventListener("unload", ke),
                ...
                De(function (e) {
                    ...
                    (i.appendChild(e).innerHTML = "<a id='" + S + "' href='' disabled='disabled'></a><select id='" + S + "-\r\\' disabled='disabled'><option selected=''></option></select>"),
                        e.querySelectorAll("[selected]").length || f.push("\\[" + n + "*(?:value|" + ge + ")"),
                    ...
                    return e === t
                        ...
                        : (n = !e.compareDocumentPosition - !t.compareDocumentPosition) ||
                              (1 & (n = (e.ownerDocument || e) == (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1) || (!g.sortDetached && t.compareDocumentPosition(e) === n)
                                  ? e === C || (e.ownerDocument == r && D.contains(r, e))
                                      ? -1
                                      : t === C || (t.ownerDocument == r && D.contains(r, t))
                                      ? 1
                                      : oe
    ...
    ((E = T.expr = {
        ...
        preFilter: {
            ...
            PSEUDO: function (e) {
                var t,
                    n = !e[6] && e[2];
                return xe.CHILD.test(e[0])
                    ? null
                    : (e[3] ? (e[2] = e[4] || e[5] || "") : n && _e.test(n) && (t = (t = Me(n, !0)) && n.indexOf(")", n.length - t) - n.length) && ((e[0] = e[0].slice(0, t)), (e[2] = n.slice(0, t))), e.slice(0, 3));
            },
        },
        filter: {
            TAG: function (e) {
        ...
        pseudos: {
            ...
            lang: l(function (n) {
                return (
                    we.test(n || "") || D.error("unsupported lang: " + n),
    ...
    function Me(e, t) {
        ...
        for (s = e, a = [], l = E.preFilter; s; ) {
            for (o in ((n && !(i = ve.exec(s))) || (i && (s = s.slice(i[0].length) || s), a.push((r = []))),
            (n = !1),
            (i = ye.exec(s)) && ((n = i.shift()), r.push({ value: n, type: i[0].replace(ee, " ") }), (s = s.slice(n.length))),
            E.filter))
                !(i = xe[o].exec(s)) || (l[o] && !(i = l[o](i))) || ((n = i.shift()), r.push({ value: n, type: o, matches: i }), (s = s.slice(n.length)));
            if (!n) break;
        }
        ...
        return (
            ...
            l(function (e, t, n, i) {
                var r,
                    ...
                    f = !h || (!e && p) ? d : Re(d, l, h, n, i);
                if ((g ? g(f, (a = v || (e ? h : u || m) ? [] : t), n, i) : (a = f), m)) for (r = Re(a, c), m(r, [], n, i), o = r.length; o--; ) (s = r[o]) && (a[c[o]] = !(f[c[o]] = s));
                if (e) {
                    if (v || h) {
                        if (v) {
                ...
                } else (a = Re(a === t ? a.splice(u, a.length) : a)), v ? v(null, t, a, i) : k.apply(t, a);
            })
        );
    }
    function Be(m, v) {
        function e(e, t, n, i, r) {
            ...
            for (r && (re = t == C || t || r); c !== g && null != (o = h[c]); c++) {
                if (b && o) {
                    for (s = 0, t || o.ownerDocument == C || (Pe(o), (n = !A)); (a = m[s++]); )
                        if (a(o, t || C, n)) {
                            k.call(i, o);
                            break;
                        }
            ...
            for (n = (t = t || Me(e)).length; n--; )
                ((o = (function e(t) {
                    for (
                        ...
                        if ((n = E.relative[t[l].type])) d = [qe(Fe(d), n)];
                        else {
                            if ((n = E.filter[t[l].type].apply(null, t[l].matches))[S]) {
                                for (r = ++l; r < o && !E.relative[t[r].type]; r++);
                                return We(1 < l && Fe(d), 1 < l && He(t.slice(0, l - 1).concat({ value: " " === t[l - 2].type ? "*" : "" })).replace(ee, "$1"), n, l < r && e(t.slice(l, r)), r < o && e((t = t.slice(r))), r < o && He(t));
                            }
                            d.push(n);
                        }
                    return Fe(d);
    ...
    function ze(e, t, n, i) {
        ...
        if (((n = n || []), 1 === u.length)) {
            ...
            for (r = xe.needsContext.test(e) ? 0 : o.length; r-- && ((s = o[r]), !E.relative[(a = s.type)]); )
                if ((l = E.find[a]) && (i = l(s.matches[0].replace(d, h), (Ae.test(o[0].type) && Ne(t.parentNode)) || t))) {
                    if ((o.splice(r, 1), (e = i.length && He(o)))) break;
                    return k.apply(n, i), n;
                }
        }
        return (c || $e(e, u))(i, t, !A, n, !t || (Ae.test(e) && Ne(t.parentNode)) || t), n;
    }
    (Ie.prototype = E.filters = E.pseudos),
        (E.setFilters = new Ie()),
        (g.sortStable = S.split("").sort(pe).join("") === S),
        Pe(),
    ...
    var Ke,
        ...
        Je =
            (((T.fn.init = function (e, t, n) {
                if (e) {
                    if (((n = n || Ke), "string" != typeof e)) return e.nodeType ? ((this[0] = e), (this.length = 1), this) : y(e) ? (void 0 !== n.ready ? n.ready(e) : e(T)) : T.makeArray(e, this);
                    if (!(i = "<" === e[0] && ">" === e[e.length - 1] && 3 <= e.length ? [null, e, null] : Ge.exec(e)) || (!i[1] && t)) return (!t || t.jquery ? t || n : this.constructor(t)).find(e);
                    if (i[1]) {
                                    ...
                                    function e() {
                                        ...
                                        if (!(r < l)) {
                                            ...
                                            (t = e && ("object" == typeof e || "function" == typeof e) && e.then),
                                                y(t)
                                                    ? a
                                                        ? t.call(e, c(l, o, tt, a), c(l, o, nt, a))
                                                        : (l++, t.call(e, c(l, o, tt, a), c(l, o, nt, a), c(l, o, tt, o.notifyWith)))
                                                    : (s !== tt && ((n = void 0), (i = [e])), (a || o.resolveWith)(n, i));
                                        }
                                    }
                                    var n = this,
                                        i = arguments,
    ...
    (T.fn.ready = function (e) {
        ...
        (T.ready.then = ot.then),
        "complete" === x.readyState || ("loading" !== x.readyState && !x.documentElement.doScroll) ? w.setTimeout(T.ready) : (x.addEventListener("DOMContentLoaded", st), w.addEventListener("load", st));
    ...
    (dt.uid = 1),
        (dt.prototype = {
            cache: function (e) {
                ...
                return t || ((t = {}), ut(e) && (e.nodeType ? (e[this.expando] = t) : Object.defineProperty(e, this.expando, { value: t, configurable: !0 }))), t;
            },
            set: function (e, t, n) {
                var i,
                    r = this.cache(e);
    ...
    function Ot(e, t, n, i, r) {
        ...
        for (u.textContent = "", f = 0; (o = d[f++]); )
            ...
            else if (((l = bt(o)), (s = m(u.appendChild(o), "script")), l && kt(s), n)) for (c = 0; (o = s[c++]); ) At.test(o.type || "") && n.push(o);
        return u;
    }
    var Dt = /^([^.]*)(?:\.(.+)|)/;
    function Lt() {
    ...
    function Bt(n, i, r, o) {
        ...
        if (d && ((t = (e = Ot(i, n[0].ownerDocument, !1, n, o)).firstChild), 1 === e.childNodes.length && (e = t), t || o)) {
            for (a = (s = T.map(m(e, "script"), Ft)).length; u < d; u++) (l = e), u !== f && ((l = T.clone(l, !0, !0)), a) && T.merge(s, m(l, "script")), r.call(n[u], l, u);
            if (a)
    ...
    function $t(e, t, n) {
        for (var i, r = t ? T.filter(t, e) : e, o = 0; null != (i = r[o]); o++) n || 1 !== i.nodeType || T.cleanData(m(i)), i.parentNode && (n && bt(i) && kt(m(i, "script")), i.parentNode.removeChild(i));
        return e;
    }
    T.extend({
        ...
        clone: function (e, t, n) {
            ...
            if (!(g.noCloneChecked || (1 !== e.nodeType && 11 !== e.nodeType) || T.isXMLDoc(e)))
                for (s = m(u), i = 0, r = (o = m(e)).length; i < r; i++)
            ...
            if (t)
                if (n) for (o = o || m(e), s = s || m(u), i = 0, r = o.length; i < r; i++) Wt(o[i], s[i]);
                else Wt(e, u);
    ...
    function nn() {
        ...
        N &&
            ...
            yt.appendChild(Jt).appendChild(N),
    ...
    function gn(e, t, n, i, r, o) {
        ...
        for (; s < 4; s += 2)
            "margin" === n && (c += T.css(e, n + vt[s], !0, r)),
                i
                    ? ("content" === n && (l -= T.css(e, "padding" + vt[s], !0, r)), "margin" !== n && (l -= T.css(e, "border" + vt[s] + "Width", !0, r)))
                    : ((l += T.css(e, "padding" + vt[s], !0, r)), "padding" !== n ? (l += T.css(e, "border" + vt[s] + "Width", !0, r)) : (a += T.css(e, "border" + vt[s] + "Width", !0, r)));
    ...
    T.extend({
        ...
        style: function (e, t, n, i) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                ...
                "string" === (o = typeof n) && (r = mt.exec(n)) && r[1] && ((n = wt(e, t, r)), (o = "number")),
                    null == n ||
                        n != n ||
            ...
            T.cssHooks[s] = {
                ...
                set: function (e, t, n) {
                    ...
                    return (
                        ...
                        n && (o = mt.exec(t)) && "px" !== (o[3] || "px") && ((e.style[s] = t), (t = T.css(e, s))),
                        pn(0, t, n)
                    );
                },
            };
    ...
    (T.Animation = T.extend(I, {
        ...
        T.fn.extend({
            fadeTo: function (e, t, n, i) {
                return this.filter(gt).css("opacity", 0).show().end().animate({ opacity: t }, e, n, i);
            },
                    ...
                    if (
                        ...
                        for (r = 0; (p = d[r++]) && !e.isPropagationStopped(); )
                            (u = p),
                                ...
                                (l = a && p[a]) && l.apply && ut(p) && ((e.result = l.apply(p, t)), !1 === e.result) && e.preventDefault();
                        return (
                            (e.type = f),
                            i ||
            ...
            (T.parseHTML = function (e, t, n) {
                ...
                return "string" != typeof e
                    ...
                    : ("boolean" == typeof t && ((n = t), (t = !1)),
                      ...
                      (i = !n && []),
                      (n = Ye.exec(e)) ? [t.createElement(n[1])] : ((n = Ot([e], t, i)), i && i.length && T(i).remove(), T.merge([], n.childNodes)));
            }),
    ...
    (function (e, t) {
        ...
        const fi = '.nav-link:not(.dropdown-toggle), .list-group-item:not(.dropdown-toggle), [role="tab"]:not(.dropdown-toggle), ' + yt;
        I, I, I;
        class hi extends t {
            constructor(e) {
                super(e),
            ...
            _activate(e, t) {
                e &&
                    ...
                    this._queueCallback(
                        () => {
                            "tab" !== e.getAttribute("role") ? e.classList.add(ui) : (e.removeAttribute("tabindex"), e.setAttribute("aria-selected", !0), this._toggleDropDown(e, !0), g.trigger(e, "shown.bs.tab", { relatedTarget: t }));
                        },
                        e,
            ...
            _keydown(t) {
                if (["ArrowLeft", ai, "ArrowUp", li, ci, "End"].includes(t.key)) {
                    ...
                    var n,
                        i = this._getChildren().filter((e) => !a(e));
                    let e;
                    (e = [ci, "End"].includes(t.key) ? i[t.key === ci ? 0 : i.length - 1] : ((n = [ai, li].includes(t.key)), U(i, t.target, n, !0))) && (e.focus({ preventScroll: !0 }), hi.getOrCreateInstance(e).show());
                }
            }
            _getChildren() {
                return d.find(fi, this._parent);
            }
            _getActiveElem() {
            ...
            _getInnerElement(e) {
                return e.matches(fi) ? e : d.findOne(fi, e);
            }
            _getOuterElement(e) {
        ...
        g.on(document, "click.bs.tab", yt, function (e) {
            ["A", "AREA"].includes(this.tagName) && e.preventDefault(), a(this) || hi.getOrCreateInstance(this).show();
        }),
            g.on(window, "load.bs.tab", () => {
                for (const e of d.find('.active[data-bs-toggle="tab"], .active[data-bs-toggle="pill"], .active[data-bs-toggle="list"]')) hi.getOrCreateInstance(e);
            }),
            e(hi);
        const pi = "show",
            gi = "showing",
        ...
        return he(yi), e(yi), { Alert: pe, Button: me, Carousel: De, Collapse: Me, Dropdown: E, Modal: Sn, Offcanvas: P, Popover: ei, ScrollSpy: si, Tab: hi, Toast: yi, Tooltip: Gn };
    });
